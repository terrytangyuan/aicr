...
For detailed architecture documentation, see [docs/contributor/README.md](/docs/contributor/).
...
- [Architecture Overview](/docs/contributor/) - System design and components
